...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AI Workforce — Funcionários digitais para sua empresa" },
      {
        name: "description",
        content:
          "Agentes de IA que executam tarefas operacionais repetitivas e devolvem horas para a sua equipe.",
      },
      { property: "og:title", content: "AI Workforce" },
      {
        property: "og:description",
        content:
          "Agentes de IA que executam tarefas operacionais e devolvem horas para sua equipe.",
      },
